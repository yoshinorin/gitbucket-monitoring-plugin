...
import net.yoshinorin.gitbucket.monitoring.services.{LogBack, GitBucketLog}
import net.yoshinorin.gitbucket.monitoring.information.logs._

trait LogController extends MonitoringControllerBase {

  get("/admin/monitoring/logs/logback")(adminOnly {
    net.yoshinorin.gitbucket.monitoring.information.logs.html.logback(
